...
class BasicBlock(nn.Module):
    """
    basic block of resnet architecture
    """
...
class ResNet(nn.Module):
    """
    class for building all variants of resnet
    """
    ...
    def __init__(
        ...
        # This will only work if model was set to train: model.train()
...
def _resnet(arch, block, layers, pretrained, **kwargs):
    ...
    if pretrained:
        raise ValueError(
            'Sight resnet is different than public resnet. ' 'It cannot use pretrained weights'
        )
    return model
...
def resnet10(pretrained=False, **kwargs):
    ...
    layers (int): Number of layers in network. Default is 4
    """
    return _resnet('resnet10', BasicBlock, [1, 1, 1, 1], pretrained, **kwargs)
